...
function PortalServer(opts) {
	...
	if (this.allowed_origins && this.allowed_origins.indexOf(this.parentOrigin) < 0) throw new Error('Target origin not allowed');
}
...
PortalServer.prototype.handleMessage = function(e) {
	if (this.allowed_origins && this.allowed_origins.indexOf(e.origin || e.originalEvent.origin) < 0) return;
